...
this.top)},setRangeWindow:function(){var a=$(window).scrollTop(),b=$(window).scrollLeft(),d=$(window).width()+b-5,c=$(window).height()+a-5;this.option.range=[b+5,a+5,d,c]},onfocus:function(){},onblur:function(){}};return{Resize:c}}());MX.extend(MX.kit,function(){function c(a){var b={dragElement:null,moveElement:null,isRange:!0,isResize:!0,offsetTop:35};this.left=this.top=this.height=this.width=0;$.extend(b,a);this.option=b;this.events={}}c.prototype={init:function(){var a=this;this.option.iscap=this.option.dragElement[0].setCapture?!0:!1;$.extend(this.events,{down:function(b){a.down(b);return!1},up:function(b){a.up(b);return!1},move:function(b){a.move(b);return!1}});this.zIndex();this.createMask();this.option.isRange&&!this.option.range&&
...
setMask:function(a,b,d,c,e){this.mask.css({top:a,left:b,width:d,height:c,"z-index":e})},setMaskIndex:function(a){this.mask.css("z-index",a||MX.ui.mxDialog.index)},start:function(){this.option.dragElement.bind("mousedown",this.events.down)},down:function(a){var b=this.option.dragElement,d=this.option.moveElement,c=$(document),e=d.offset();this.width=d.width()+7;this.height=d.height()+7+this.option.offsetTop;this.setRangeWindow();this.option.iscap&&b[0].setCapture();this.offset={x:a.screenX-e.left,
y:a.screenY-e.top};this.showMask();c.bind("mousemove",this.events.move);c.bind("mouseup",this.events.up);this.onfocus(a.screenX,a.screenY)},move:function(a){var b=this.option.moveElement,d=this.offset,c=a.screenX-d.x-$(window).scrollLeft(),a=a.screenY-d.y-$(window).scrollTop();if(this.option.isRange)a=this.checkBoundary(c,a),c=a.x,a=a.y;this.left=c;this.top=a;b[0].style.left=c+"px";b[0].style.top=a+"px";this.onmove(c,a)},up:function(){var a=$(document),b=this.option.dragElement;this.option.iscap&&
