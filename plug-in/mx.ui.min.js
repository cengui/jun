...
this.top)},setRangeWindow:function(){var b=$(window).scrollTop(),a=$(window).scrollLeft(),d=$(window).width()+a-5,e=$(window).height()+b-5;this.option.range=[a+5,b+5,d,e]},onfocus:function(){},onblur:function(){}};return{Resize:c}}());
MX.extend(MX.kit,function(){function c(b){var a={dragElement:null,moveElement:null,isRange:!0,isResize:!0,patchWidth:0,patchHeight:0,patchTop:0,patchLeft:0};this.left=this.top=this.height=this.width=0;$.extend(a,b);this.option=a;this.events={}}c.prototype={init:function(){var b=this;this.option.iscap=this.option.dragElement[0].setCapture?!0:!1;$.extend(this.events,{down:function(a){b.down(a);return!1},up:function(a){b.up(a);return!1},move:function(a){b.move(a);return!1}});this.zIndex();this.createMask();
