...
setMask:function(a,b,d,e,c){this.mask.css({top:a,left:b,width:d,height:e,"z-index":c})},setMaskIndex:function(a){this.mask.css("z-index",a||MX.mxDialog.index)},start:function(){this.option.dragElement.bind("mousedown",this.events.down)},down:function(a){var b=this.option.dragElement,d=this.option.moveElement,e=$(document),c=d.offset();this.width=d.width()+7;this.height=d.height()+7+this.option.offsetTop;this.setRangeWindow();this.option.iscap&&b[0].setCapture();this.offset={x:a.screenX-c.left,y:a.screenY-
c.top};this.showMask();e.bind("mousemove",this.events.move);e.bind("mouseup",this.events.up);this.onfocus(a.screenX,a.screenY)},move:function(a){var b=this.option.moveElement,d=this.offset,e=a.screenX-d.x-$(window).scrollLeft(),a=a.screenY-d.y-$(window).scrollTop();if(this.option.isRange)a=this.checkBoundary(e,a),e=a.x,a=a.y;this.left=e;this.top=a;b[0].style.left=e+"px";b[0].style.top=a+"px";this.onmove(e,a)},up:function(){var a=$(document),b=this.option.dragElement;this.option.iscap&&b[0].releaseCapture();
this.hideMask();a.unbind("mousemove",this.events.move);a.unbind("mouseup",this.events.up);this.onblur()},stop:function(){this.removeMask()},checkBoundary:function(a,b){var d=this.option.range,a=a>d[2]-this.width?d[2]-this.width:a,b=b>d[3]-this.height?d[3]-this.height:b,a=a<d[0]?d[0]:a,b=b<d[1]?d[1]:b;return{x:a,y:b}},setResize:function(){var a=this;if(!this.option.isResize)return this.option.moveElement.find(".mx-dialog-change").hide(),!1;this.resize=new MX.kit.Resize({dragElements:this.option.moveElement.find(".mx-dialog-change"),
sizeElement:this.option.moveElement});this.resize.onfocus=function(){a.showMask();a.setMaskIndex()};this.resize.onblur=function(b,d,e,c){a.width=b;a.height=d;a.top=c;a.left=e;a.onResize();a.hideMask()};this.resize.init()},setRange:function(a,b,c,e){this.option.isRange=!0;this.option.range=[a,b,c,e]},setRangeWindow:function(){var a=$(window).width()+0,b=$(window).height()+0;this.option.isRange=!0;this.option.range=[0,0,a,b];this.setMask(0,0,a,b,this.minzIndex)},onfocus:function(){},onblur:function(){},
onmove:function(){},onexit:function(){},onready:function(){},onResize:function(){}};return{DragElement:c}}());
MX.extend(MX.ui,function(){function c(a){this.isMax=!1;this.isClose=!0;this.isResize=this.isMaximize=!1;this.isMove=!0;this.title="MoXian.com";this.minHeight=this.minWidth=100;this.width=400;this.height=300;this.left=this.top=0;this.overflow=!0;this.i=c.count++;this.index=c.index++;this.ui={};$.extend(this,a)}c.dialogList=[];c.count=1;c.index=100;c.lang={cn:{home:"\u4e3b\u9875",maximize:"\u6700\u5927\u5316",restore:"\u8fd8\u539f",close:"\u5173\u95ed"},en:{home:"Home",maximize:"Maximize",restore:"Restore",
close:"Close"}};c.lang.currentLang=c.lang.cn;c.prototype={getTpl:function(){var a=c.lang.currentLang;return'<div class="mx-dialog" id="mxDialog_<%=i%>" style="width:<%=width%>px;height:<%=height%>px;left:<%=left%>px;top:<%=top%>px;z-index:<%=index%>">\t\t\t\t<div class="mx-dialog-t mx-dialog-change" style="display:none;" data-dir="t"></div>\t\t\t\t<div class="mx-dialog-b mx-dialog-change" style="display:none;" data-dir="b"></div>\t\t\t\t<div class="mx-dialog-r mx-dialog-change" style="display:none;" data-dir="r"></div>\t\t\t\t<div class="mx-dialog-l mx-dialog-change"  style="display:none;" data-dir="l"></div>\t\t\t\t<div class="mx-dialog-tr mx-dialog-change"  style="display:none;" data-dir="tr"></div>\t\t\t\t<div class="mx-dialog-tl mx-dialog-change" style="display:none;" data-dir="tl"></div>\t\t\t\t<div class="mx-dialog-br mx-dialog-change" style="display:none;" data-dir="br"></div>\t\t\t\t<div class="mx-dialog-bl mx-dialog-change" style="display:none;" data-dir="bl"></div>\t\t\t\t<div class="mx-dialog-title"><div class="mx-dialog-title-in">\t\t\t\t\t<div class="mx-dialog-tool"><a href="###" class="mx-dialog-home" title="'+
